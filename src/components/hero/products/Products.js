        ...
        <div className="p-4 md:w-1/3">
            <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                <Link to={`/product/${el.id}`}>
                    <img className="lg:h-48 md:h-36 w-full object-contain object-center" src={el.image} alt="blog" />
                </Link>
                <div className="p-6">
                    ...
                    <div className="flex items-center flex-wrap ">
                        <Link to={"/single"} className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">Learn More
