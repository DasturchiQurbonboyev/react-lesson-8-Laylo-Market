                ...
                <div className="container px-5 py-24  ">
                    <form onSubmit={handleSubmit} className="  bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto mr-auto w-full mt-10 md:mt-0">
                        ...
                        <div className="relative mb-4">
                            ...
                            <input value={username} onChange={e => setUsername(e.target.value)} type="text" id="full-name" name="full-name" className="w-full bg-white rounded border border-gray-300  text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                        </div>
                        ...
                        <div className="relative flex justify-between items-center  px-5 py-1 mb-4 bg-white bottom-1 rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200">
                            <input value={password} onChange={e => setPassword(e.target.value)} type={showpassword ? "text" : "password"} id="email" name="email" className=" bg-white rounded border-none outline-none    focus:ring-indigo-200 text-base outline-none text-gray-700 leading-8 transition-colors duration-200 ease-in-out" />
