...
function Login() {
    return (
        <>
            <section class="text-gray-600 body-font  ml-auto mr-auto container">
                <div class="container px-5 py-24  ">
                    <div class="w-[500px]  bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto mr-auto w-full mt-10 md:mt-0">
